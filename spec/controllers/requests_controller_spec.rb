...
describe RequestsController do
  ...
  let(:valid_attributes) { { "plano" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved request as @request" do
        ...
        post :create, {:request => { "plano" => "invalid value" }}, valid_session
        assigns(:request).should be_a_new(Request)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested request" do
        ...
        Request.any_instance.should_receive(:update).with({ "plano" => "MyString" })
        put :update, {:id => request.to_param, :request => { "plano" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the request as @request" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Request.any_instance.stub(:save).and_return(false)
        put :update, {:id => request.to_param, :request => { "plano" => "invalid value" }}, valid_session
        assigns(:request).should eq(request)
      end
